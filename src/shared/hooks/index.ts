...
/**
 * Configuración global para hooks
 */
...
let globalConfig: GlobalHookConfig = {
  enableDebug: false,
 ...
 */
export const configureHooks = (config: Partial<GlobalHookConfig>): void => {
 ...
 */
export const getHookConfig = (): GlobalHookConfig => {
  return { ...globalConfig };
};
 ...
 */
export const resetHookConfig = (): void => {
  globalConfig = {
    enableDebug: false,
