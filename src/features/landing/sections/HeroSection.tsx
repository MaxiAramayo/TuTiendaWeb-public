        ...
        <div className='flex flex-col md:flex-row items-center gap-10 md:gap-0'>
          ...
          >
            ...
            <motion.p
              ...
              variants={itemAnimation}
            >
              Creá tu catálogo digital, compartilo por WhatsApp y recibí pedidos
              desde cualquier dispositivo. Para tiendas, restaurantes y
            ...
            >
              ...
              <CtaButton
                href={process.env.NEXT_PUBLIC_DEMO_STORE_URL ?? '/demo'}
                variant='outline'
                size='lg'
                className='w-full sm:w-auto'
              >
